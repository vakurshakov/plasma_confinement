...
ddata = {
    ...
    'jx': [ "jx.txt", [], (0,0), "$\hatj_x$", "$(\ \hatx/h,\ \haty/h\ =\ Ny/2\ )$", (-7e-3, 7e-3) ],
    'jy': [ "jy.txt", [], (0,1), "$\hatj_y$", "$(\ \hatx/h,\ \haty/h\ =\ Ny/2\ )$", (-7e-3, 7e-3) ],
    'jz': [ "jz.txt", [], (0,2), "$\hatj_z$", "$(\ \hatx/h,\ \haty/h\ =\ Ny/2\ )$", (-7e-1, 7e-1) ],
    'Ex': [ "Ex.txt", [], (1,0), "$\hatE_x$", "$(\ \hatx/h,\ \haty/h\ =\ Ny/2\ )$", (-7e-3, 7e-3) ],
    'Ey': [ "Ey.txt", [], (1,1), "$\hatE_y$", "$(\ \hatx/h,\ \haty/h\ =\ Ny/2\ )$", (-7e-3, 7e-3) ],
    'Ez': [ "Ez.txt", [], (1,2), "$\hatE_z$", "$(\ \hatx/h,\ \haty/h\ =\ Ny/2\ )$", (-7e-3, 7e-3) ],
    'Bx': [ "Bx.txt", [], (2,0), "$\hatB_x$", "$(\ \hatx/h,\ \haty/h\ =\ Ny/2\ )$", (-7e-2, 7e-2) ],
    'By': [ "By.txt", [], (2,1), "$\hatB_y$", "$(\ \hatx/h,\ \haty/h\ =\ Ny/2\ )$", (-7e-4, 7e-4) ],
    'Bz': [ "Bz.txt", [], (2,2), "$\hatB_z$", "$(\ \hatx/h,\ \haty/h\ =\ Ny/2\ )$", (-7e-4, 7e-4) ],
