...
{	
	//___ collecting jx(y,x) ______________________________________________________________________	
...
{	
	//___ collecting jy(y,x) ______________________________________________________________________
	long int node_x, node_y;
...
{	
	//___ collecting jz(y,x) ______________________________________________________________________
	long int node_x, node_y;

	const vector2& r = point.r(); 
	const double gamma = sqrt(1 + point.p().dot(point.p())/(m_*m_));
	const double vz = point.pz()/gamma;
